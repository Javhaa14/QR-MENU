...
export default function MinimalList({
  ...
  return (
    <article
      className={`grid gap-4 rounded-[calc(var(--radius)+0.1rem)] border border-black/10 bg-white/55 px-4 py-4 ${
        isMobile ? "" : "md:grid-cols-[1fr_auto_auto] md:items-center"
      }`}
    >
      ...
      {showAddButton && onAdd ? (
        <div className={isMobile ? "" : "md:justify-self-end"}>
